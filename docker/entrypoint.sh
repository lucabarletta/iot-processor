...
export DOCKER_INFLUXDB_SENSOR_BUCKET=$DOCKER_INFLUXDB_SENSOR_BUCKET
export DOCKER_INFLUXDB_SENSOR_RETENTION=$DOCKER_INFLUXDB_SENSOR_RETENTION
...
influx bucket create --skip-verify --name ${DOCKER_INFLUXDB_SENSOR_BUCKET} --retention ${DOCKER_INFLUXDB_SENSOR_RETENTION} --org ${DOCKER_INFLUXDB_INIT_ORG} --host http://${DOCKER_INFLUXDB_INIT_HOST}:8086 --token ${DOCKER_INFLUXDB_INIT_ADMIN_TOKEN} --force